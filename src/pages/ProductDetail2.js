...
const ProductDetail2 = () => {
  ...
  if (!product) {
    return <div className='text-4xl text-center mt-[100px] mb-[50px]'>Loading...</div>;
  }
        ...
        <div className='container mx-auto p-4'>
          ...
          <div className='items-start flex lg:flex-row md:flex-row flex-col justify-center lg:gap-[140px] md:gap-[40px] gap-[30px]'>
            <div className='flex flex-col gap-[20px]'>
              <img src={product.thumbnail} alt={product.title} className='h-[450px] w-[506px] drop-shadow-lg shadow-black border-2 border-gray-500 p-2' />
              <div className='flex gap-[10px]'>
                <img src={product.thumbnail} alt={product.title} className='h-[75px] w-[100px] drop-shadow-lg shadow-black border-2 border-gray-500 p-2' />
                <img src={product.thumbnail} alt={product.title} className='h-[75px] w-[100px] drop-shadow-lg shadow-black border-2 border-gray-500 p-2' />
              </div>
            </div>
