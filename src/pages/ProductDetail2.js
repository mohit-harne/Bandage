...
const ProductDetail2 = () => {
  ...
  if (!product) {
    return (
      <div className="text-4xl text-center mt-[100px] mb-[50px]">
        Loading...
      </div>
    );
  }
        ...
        <div className="container mx-auto p-4">
          ...
          <div className="items-start flex lg:flex-row md:flex-row flex-col justify-center lg:gap-[140px] md:gap-[40px] gap-[30px]">
            <div className="flex flex-col gap-[20px]">
              <img
                ...
                alt={product.title}
                className="h-[450px] w-[506px] drop-shadow-lg shadow-black border-2 border-gray-500 p-2"
              />
              <div className="flex gap-[10px]">
                <img
                  src={product.thumbnail}
                  alt={product.title}
                  className="h-[75px] w-[100px] drop-shadow-lg shadow-black border-2 border-gray-500 p-2"
                />
                <img
                  src={product.thumbnail}
                  alt={product.title}
            ...
            <div className="flex flex-col gap-[30px] h-[471px] ">
              <div className="leading-[60px]">
                <h1 className="text-[20px] font-bold text-[#252B42]">
                  {product.title}
                </h1>
                <img className="w-[221px] h-[24px]" src={rating} alt="M" />
              </div>
              <div className="leading-[40px]">
                <p className="text-[24px] text-[#252B42] font-bold">
                  ${product.price}
                </p>
              ...
              <p className="text-[14px] text-[#858585] lg:w-[460px] md:w-[350px] w-[360px]">
                {product.description}
              </p>
              ...
              <div className="flex gap-[10px]">
                <button className="text-[14px] text-white font-bold px-[20px] py-[10px] bg-[#23A6F0] rounded-md">
                  Select Options
                </button>
          ...
          <div className="lg:mt-[100px] md:mt-[50px] mt-[60px]">
            <div className="flex lg:gap-[50px] md:gap-[50px] gap-[20px] justify-center items-center h-[72px]">
              <h1 className="text-[14px] text-[#737373] font-semibold">
                Description
              </h1>
              <h1 className="text-[14px] text-[#737373] font-bold">
            ...
            <div className="flex lg:flex-row md:flex-row md:cols-2 flex-col lg:gap-[70px] md:gap-[50px] gap-[20px] justify-center items-center mt-[70px]">
              ...
              <div className="w-[310px] flex flex-col gap-[30px]">
                <h1 className="text-[24px] text-[#252B42] font-bold">
          ...
          <div className="flex justify-center items-center lg:mt-0 md:mt-[50px] mt-[-250px]">
            <Bestseller />
          </div>
