...
const Contact = () => {
  ...
  <h1 className='text-[58px] text-[#252B42] font-bold text-center'>Get in touch today!</h1>
  <h1 className='text-[20px] text-[#737373] w-[330px] text-center'>We know how large objects will act, but things on a small scale</h1>
  <div>
  <h1 className='text-[24px] text-[#252B42] font-bold text-center'>Phone : +451 215 215 </h1>
  <h1 className='text-[24px] text-[#252B42] font-bold text-center'>Fax : +451 215 215</h1>
  </div>
...
<div>
<h1 className='text-[14px] text-[#252B42] font-bold text-center'>VISIT OUR OFFICE</h1>
<h1 className='text-[40px] text-[#252B42] font-bold text-center lg:w-[480px] md:w-[480px] w-[380px]'>We help small businesses with big ideas</h1>
</div>
...
<h1 className='text-[14px] text-[#252B42] font-bold'>georgia.young@example.com</h1>
<h1 className='text-[14px] text-[#252B42] font-bold'>georgia.young@ple.com</h1>
<h1 className='text-[16px] text-[#252B42] font-bold'>Get Support</h1>
<button className='text-[14px] text-[#23A6F0] font-bold border-2 border-[#23A6F0] rounded-[50px] hover:bg-gray-200 p-[15px] w-[189px]'>Submit Request</button>
  </div>
...
<h1 className='text-[14px] text-white font-bold'>georgia.young@example.com</h1>
<h1 className='text-[14px] text-white font-bold'>georgia.young@ple.com</h1>
<h1 className='text-[16px] text-white font-bold'>Get Support</h1>
<button className='text-[14px] text-[#23A6F0] font-bold border-2 border-[#23A6F0] rounded-[50px] hover:bg-blue-700 p-[15px] w-[189px]'>Submit Request</button>
  </div>
  <div className='h-[403px] w-[329px] justify-center items-center flex flex-col  gap-[30px]'>
...
<div className='lg:mt-[70px] md:mt-[50px] mt-[20px] flex flex-col gap-[20px] justify-center items-center lg:mb-[50px] md:mb-[20px] mb-[20px]'>
  ...
  <h1 className='text-[16px] text-[#252B42] font-bold text-center'>WE Can't WAIT TO MEET YOU</h1>
  <h1 className='text-[58px] text-[#252B42] font-bold text-center'>Let’s Talk</h1>
  <button className='text-[14px] text-white font-bold bg-[#23A6F0] p-[15px] w-[186px] rounded-md'>Try it free now</button>
</div>
