...
<h1 className='text-[16px] text-[#252B42] font-bold'>ABOUT COMPANY</h1>
<h1 className='text-[58px] text-[#252B42] font-bold'>ABOUT US</h1>
<h1 className='text-[20px] text-[#737373] w-[330px]'>We know how large objects will act, but things on a small scale</h1>
<button className='text-[14px] text-white font-bold bg-[#23A6F0] px-[40px] py-[15px] w-[193px] rounded-md'>Get Quote Now</button>
  </div>
...
<h1 className='text-[24px] text-[#252B42] font-bold w-[370px]'>Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.</h1>
  </div>
  <h1 className='text-[14px] text-[#737373] lg:w-[520px] md:w-[350px] w-[370px]'>Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </h1>
</div>
<div className='lg:h-[264px] md:h-[264px] h-[300px] grid lg:grid-cols-4 md:grid-cols-4 grid-cols-2 justify-center items-center lg:mt-[80px] md:mt-[0] mt-[50px]'>
  <div className='flex flex-col justify-center items-center'>
    ...
    <h1 className='text-[16px] text-[#737373] font-bold'>Happy Customers</h1>
  </div>
  <div className='flex flex-col justify-center items-center'>
    <h1 className='text-[58px] text-[#252B42] font-bold'>150K</h1>
    <h1 className='text-[16px] text-[#737373] font-bold'>Monthly Visitors</h1>
  </div>
  <div className='flex flex-col justify-center items-center'>
    <h1 className='text-[58px] text-[#252B42] font-bold'>15</h1>
    <h1 className='text-[16px] text-[#737373] font-bold'>Countries Worldwide</h1>
  </div>
  <div className='flex flex-col justify-center items-center'>
...
<div className='lg:mt-[100px] md:mt-[20px] mt-[20px] flex flex-col items-center justify-center gap-[10px]'>
  ...
  <h1 className='text-[14px] text-[#737373] lg:w-[440px] md:w-[469px] w-[380px] text-center'>Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </h1>
...
<h1 className='text-[40px] text-[#252B42] font-bold text-center'>Big Companies Are Here</h1>
<h1 className='text-[14px] text-[#737373] w-[350px] text-center'>Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </h1>
...
<h1 className='text-[40px] font-bold text-center'>Now Let’s grow Yours</h1>
<h1 className='text-[14px] w-[400px] text-center'>The gradual accumulation of information about atomic and small-scale behavior during the first quarter of the 20th </h1>
<button className='rounded-lg text-[14px] font-bold border-2 border-[#FAFAFA] px-[40px] py-[15px] w-[130px] hover:opacity-85'>Button</button>
  </div>
  <img className='h-[640px] w-[590px] hidden lg:block md:block' src={about5} alt='M'/>
</div>
    </div>
  )
}
